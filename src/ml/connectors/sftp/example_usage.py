...
def example_with_config():
    ...
    """
    print("\n" + "="*60)
    print("EXEMPLE 3: Utilisation avec configuration YAML")
    print("="*60 + "\n")
...
def example_prefect_task():
    ...
    """
    print("\n" + "="*60)
    print("EXEMPLE 4: Utilisation avec tâches Prefect")
    print("="*60 + "\n")
...
def example_list_files():
    ...
    """
    print("\n" + "="*60)
    print("EXEMPLE 5: Lister les fichiers sur SFTP")
    print("="*60 + "\n")
...
def main():
    ...
    try:
        # Exemple 3: Utilisation avec configuration YAML
        # example_with_config()
        pass
    except Exception as e:
