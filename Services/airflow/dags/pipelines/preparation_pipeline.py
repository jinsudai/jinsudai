"""
Airflow DAG pour déclencher le pipeline de préparation via GitHub Action.

Ce DAG:
- Déclenche le workflow GitHub Action 2_preparation_pipeline.yml
...
with DAG(
    ...
    trigger_task = PythonOperator(
        ...
        op_kwargs={'github_workflow': '2_preparation_pipeline.yml'},
    )
